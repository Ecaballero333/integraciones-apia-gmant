...
public class ExecResultType  implements java.io.Serializable {
    ...
    private uy.com.st.integration.client.ws.axis.apia.Parameter parameters;
    ...
    public ExecResultType(
           ...
           uy.com.st.integration.client.ws.axis.apia.Parameter parameters) {
     ...
     * @return parameters
     */
    public uy.com.st.integration.client.ws.axis.apia.Parameter getParameters() {
        return parameters;
    }
     ...
     * @param parameters
     */
    public void setParameters(uy.com.st.integration.client.ws.axis.apia.Parameter parameters) {
        this.parameters = parameters;
    }
